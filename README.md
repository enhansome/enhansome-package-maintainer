...
* [NixOS](https://github.com/NixOS/nixpkgs/issues) ⭐ 26,247 | 🐛 21,494 | 🌐 Nix | 📅 2026-09-25
...
[ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,594 | 🐛 203 | 🌐 Rust | 📅 2026-08-04 is similar to ag but written in Rust.
...
* [spec-cleaner](https://github.com/rpm-software-management/spec-cleaner) ⭐ 33 | 🐛 1 | 🌐 Python | 📅 2026-09-25 (`zypper in spec-cleaner`) to clean the spec file according to the style guide.
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 165 | 🐛 104 | 🌐 Python | 📅 2026-09-25, for
  .rpm packages.
...
You can find more details about how to configure in the [rpmlint doc](https://github.com/rpm-software-management/rpmlint?tab=readme-ov-file#configuration) ⭐ 165 | 🐛 104 | 🌐 Python | 📅 2026-09-25
