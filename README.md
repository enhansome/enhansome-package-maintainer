# Awesome Package Maintainer with stars
...
* Use [nvchecker](https://github.com/lilydjwg/nvchecker) ⭐ 562 | 🐛 13 | 🌐 Python | 📅 2026-08-04.
...
* [NixOS](https://github.com/NixOS/nixpkgs/issues) ⭐ 25,796 | 🐛 21,597 | 🌐 Nix | 📅 2026-08-14
...
[wiggle](https://github.com/neilbrown/wiggle/) ⭐ 108 | 🐛 6 | 🌐 C | 📅 2024-07-23 applies rejected patches and performs word-wise diffs.
...
[ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,314 | 🐛 175 | 🌐 Rust | 📅 2026-08-04 is similar to ag but written in Rust.
...
[magic-trace](https://github.com/janestreet/magic-trace) ⭐ 6,233 | 🐛 67 | 🌐 OCaml | 📅 2026-06-17 is similar to perf.
...
More tools and their usage can be found in Johannst's [notes](https://johannst.github.io/notes/trace_profile/index.html). He mentions strace, ltrace, perf OProfile, callgrind, vtune, tracy and more.
...
[seer](https://github.com/epasveer/seer) ⭐ 3,428 | 🐛 42 | 🌐 C++ | 📅 2026-08-13 is a nice GUI frontend for gdb.
...
* [mgornys Gentoo dev scripts](https://github.com/projg2/mgorny-dev-scripts) ⭐ 39 | 🐛 6 | 🌐 Shell | 📅 2026-08-11
* [release-notes-scraper](https://github.com/dcermak/release-notes-scraper) ⭐ 7 | 🐛 2 | 🌐 Python | 📅 2026-08-10 - grab the release notes for projects from GitHub that do not keep a CHANGELOG, but publish their release notes via the releases page.
...
* [sam-gentoo-scripts](https://github.com/thesamesam/sam-gentoo-scripts) ⭐ 24 | 🐛 1 | 🌐 Shell | 📅 2026-07-18 - [sams](https://github.com/thesamesam) Gentoo development scripts
...
* [grc](https://github.com/garabik/grc) ⭐ 2,188 | 🐛 95 | 🌐 Python | 📅 2024-08-18 (`zypper in grc`) to have colorized and more readable output when building with `grc osc build`.
...
Let's say you maintain the libstrophe library and want to find out which packages depend on in (in Factory on x86\_64):
...
* [openSUSE-helpers](https://github.com/DimStar77/openSUSE-helpers) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-07-29 by [DimStar77](https://github.com/DimStar77).
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 163 | 🐛 88 | 🌐 Python | 📅 2026-08-11, for
  .rpm packages.
...
You can find more details about how to configure in the [rpmlint doc](https://github.com/rpm-software-management/rpmlint?tab=readme-ov-file#configuration) ⭐ 163 | 🐛 88 | 🌐 Python | 📅 2026-08-11
