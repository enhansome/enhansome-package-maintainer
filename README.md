...
* Use [nvchecker](https://github.com/lilydjwg/nvchecker) ⭐ 566 | 🐛 13 | 🌐 Python | 📅 2026-09-06.
...
* [NixOS](https://github.com/NixOS/nixpkgs/issues) ⭐ 26,045 | 🐛 21,200 | 🌐 Nix | 📅 2026-09-07
...
[ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,042 | 🐛 188 | 🌐 Rust | 📅 2026-08-04 is similar to ag but written in Rust.
...
[magic-trace](https://github.com/janestreet/magic-trace) ⭐ 6,263 | 🐛 70 | 🌐 OCaml | 📅 2026-08-19 is similar to perf.
...
[seer](https://github.com/epasveer/seer) ⭐ 3,433 | 🐛 41 | 🌐 C++ | 📅 2026-09-06 is a nice GUI frontend for gdb.
...
* [grc](https://github.com/garabik/grc) ⭐ 2,196 | 🐛 95 | 🌐 Python | 📅 2024-08-18 (`zypper in grc`) to have colorized and more readable output when building with `grc osc build`.
...
* [openSUSE-helpers](https://github.com/DimStar77/openSUSE-helpers) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-08-25 by [DimStar77](https://github.com/DimStar77).

### Blog(posts)

* [How to find, debug and fix reproducibility issues in openSUSE OBS package build results](https://github.com/bmwiedemann/reproducibleopensuse/blob/master/howtodebug) ⭐ 15 | 🐛 1 | 🌐 Shell | 📅 2026-08-25 by [bmwiedemann](https://github.com/bmwiedemann).
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 163 | 🐛 90 | 🌐 Python | 📅 2026-09-01, for
  .rpm packages.
...
You can find more details about how to configure in the [rpmlint doc](https://github.com/rpm-software-management/rpmlint?tab=readme-ov-file#configuration) ⭐ 163 | 🐛 90 | 🌐 Python | 📅 2026-09-01
