...
* [NixOS](https://github.com/NixOS/nixpkgs/issues) ⭐ 26,218 | 🐛 21,417 | 🌐 Nix | 📅 2026-09-23
...
[ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,528 | 🐛 200 | 🌐 Rust | 📅 2026-08-04 is similar to ag but written in Rust.
...
* [spec-cleaner](https://github.com/rpm-software-management/spec-cleaner) ⭐ 33 | 🐛 12 | 🌐 Python | 📅 2026-09-22 (`zypper in spec-cleaner`) to clean the spec file according to the style guide.
...
* [openSUSE-helpers](https://github.com/DimStar77/openSUSE-helpers) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-09-22 by [DimStar77](https://github.com/DimStar77).
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 165 | 🐛 95 | 🌐 Python | 📅 2026-09-22, for
  .rpm packages.
...
You can find more details about how to configure in the [rpmlint doc](https://github.com/rpm-software-management/rpmlint?tab=readme-ov-file#configuration) ⭐ 165 | 🐛 95 | 🌐 Python | 📅 2026-09-22
