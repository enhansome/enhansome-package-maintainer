...
* [NixOS](https://github.com/NixOS/nixpkgs/issues) ⭐ 26,236 | 🐛 21,416 | 🌐 Nix | 📅 2026-09-24
...
[ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,563 | 🐛 201 | 🌐 Rust | 📅 2026-08-04 is similar to ag but written in Rust.
...
[magic-trace](https://github.com/janestreet/magic-trace) ⭐ 6,277 | 🐛 70 | 🌐 OCaml | 📅 2026-08-19 is similar to perf.
...
[seer](https://github.com/epasveer/seer) ⭐ 3,441 | 🐛 42 | 🌐 C++ | 📅 2026-09-13 is a nice GUI frontend for gdb.
...
* [spec-cleaner](https://github.com/rpm-software-management/spec-cleaner) ⭐ 33 | 🐛 8 | 🌐 Python | 📅 2026-09-23 (`zypper in spec-cleaner`) to clean the spec file according to the style guide.
...
* [openSUSE-helpers](https://github.com/DimStar77/openSUSE-helpers) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-09-24 by [DimStar77](https://github.com/DimStar77).

### Blog(posts)

* [How to find, debug and fix reproducibility issues in openSUSE OBS package build results](https://github.com/bmwiedemann/reproducibleopensuse/blob/master/howtodebug) ⭐ 15 | 🐛 1 | 🌐 Shell | 📅 2026-09-09 by [bmwiedemann](https://github.com/bmwiedemann).
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 165 | 🐛 108 | 🌐 Python | 📅 2026-09-22, for
  .rpm packages.
...
You can find more details about how to configure in the [rpmlint doc](https://github.com/rpm-software-management/rpmlint?tab=readme-ov-file#configuration) ⭐ 165 | 🐛 108 | 🌐 Python | 📅 2026-09-22
