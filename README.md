...
* [NixOS](https://github.com/NixOS/nixpkgs/issues) ⭐ 26,212 | 🐛 21,313 | 🌐 Nix | 📅 2026-09-22
...
[ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,502 | 🐛 200 | 🌐 Rust | 📅 2026-08-04 is similar to ag but written in Rust.
...
[magic-trace](https://github.com/janestreet/magic-trace) ⭐ 6,276 | 🐛 70 | 🌐 OCaml | 📅 2026-08-19 is similar to perf.
...
* [spec-cleaner](https://github.com/rpm-software-management/spec-cleaner) ⭐ 33 | 🐛 8 | 🌐 Python | 📅 2026-09-22 (`zypper in spec-cleaner`) to clean the spec file according to the style guide.
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 165 | 🐛 89 | 🌐 Python | 📅 2026-09-22, for
  .rpm packages.
...
You can find more details about how to configure in the [rpmlint doc](https://github.com/rpm-software-management/rpmlint?tab=readme-ov-file#configuration) ⭐ 165 | 🐛 89 | 🌐 Python | 📅 2026-09-22
